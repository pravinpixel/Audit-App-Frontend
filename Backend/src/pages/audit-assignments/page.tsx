...
import { Download, ClipboardList, CheckCircle2, XCircle, Flame } from "lucide-react"
...
export default function AuditAssignmentsPage() {
  ...
  const handleExport = () => {
    console.log("Exporting audit assignments...")
  }
  ...
  const summaryCards = [
    ...
    {
      title: "Assigned",
      value: filteredAssignments.filter((a) => a.assignmentStatus === "Assigned").length,
      icon: CheckCircle2,
    ...
    {
      title: "Not Assigned",
      value: filteredAssignments.filter((a) => a.assignmentStatus === "Not Assigned").length,
      icon: XCircle,
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Audit Assignments</h1>
            <p className="text-sm text-gray-600 mt-1">Manage audit requests and sales person assignments</p>
          </div>
          <Button

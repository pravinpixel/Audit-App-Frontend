...
interface AuditEnquiryFiltersProps {
  searchQuery: string
...
export function AuditEnquiryFilters({
  searchQuery,
  onSearchChange,
  industryTypeFilter,
  ...
  const headOffices = ["Bangalore", "Mumbai", "Delhi", "Chennai", "Hyderabad", "Pune", "Goa", "Kolkata"]
  const states = ["Karnataka", "Maharashtra", "Delhi", "Tamil Nadu", "Telangana", "Goa", "West Bengal"]
  const cities = ["Bangalore", "Mumbai", "New Delhi", "Chennai", "Hyderabad", "Pune", "Panaji", "Kolkata"]
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search by Customer Name, Industry Type, Location, or City..."
            value={searchQuery}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="w-full justify-between h-9 border-gray-300 bg-transparent">
                  <span className="text-sm truncate">
                    {headOfficeFilter.length > 0 ? `Head Office (${headOfficeFilter.length})` : "Head Office Location"}
                  </span>
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-56 p-3" align="start">

...
export function CustomerTable({
  ...
  console.log(
    "[v0] Customer data sample:",
    customers.length > 0
      ? {
          id: customers[0].id,
          auditorName: customers[0].auditorName,
          auditorMobile: customers[0].auditorMobile,
          auditorEmail: customers[0].auditorEmail,
        }
      : "No customers",
  )
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
        <h2 className="text-lg font-semibold text-gray-900">Customer List ({filteredCustomers.length})</h2>
      </div>
